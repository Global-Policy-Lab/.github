...
Huang et al (2021). Using Satellite Imagery and Deep Learning to Evaluate the Impact of Anti-Poverty Programs. [Paper](Using Satellite Imagery and Deep Learning to Evaluate the Impact of Anti-Poverty Programs). [Code](https://github.com/luna983/beyond-nightlight).
