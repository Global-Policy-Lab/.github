...
- Almås et al (2025). Destructive Behaviour, Judgement and Economic Decision-making under Thermal Stress. [_The Economic Journal_](https://academic.oup.com/ej/article/135/672/2483/7964900).  
...
- Noda et al (2024). A machine-learning pipeline for merging and georeferencing very large archives of historical aerial photographs. [_2024 IEEE International Conference on Big Data_](https://ieeexplore.ieee.org/abstract/document/10825635). 
- Burke, Ferguson, Hsiang, and Miguel. (2024) New Evidence on the Economics of Climate and Conflict. [Handbook of the Economics of Conflict](https://www.sciencedirect.com/science/chapter/handbook/abs/pii/S2949836824000083).
- Burke et al (2024). Are we adapting to climate change? [_NBER Working Paper_](https://www.nber.org/papers/w32985).
- Tallis et al (2024). Mainstreaming nature in US federal policy. [_Science_](https://www.science.org/doi/10.1126/science.adp5394).
...
- Carleton et al (2022). Valuing the Global Mortality Consequences of Climate Change Accounting for Adaptation Costs and Benefits. [_Quarterly Journal of Economics_](https://academic.oup.com/qje/article/137/4/2037/6571943). [Code Available](https://github.com/ClimateImpactLab/carleton_mortality_2022). [Data Available](https://dataverse.harvard.edu/citation?persistentId=doi:10.7910/DVN/FXXLYZ).
...
- Rode et al (2021). Estimating a Social Cost of Carbon for Global Energy Consumption. [_Nature_](https://www.nature.com/articles/s41586-021-03883-8). [Code available](https://github.com/ClimateImpactLab/energy-code-release-2020/). [Data available](https://zenodo.org/records/5099834).
...
- Bates et al (2021). Combined Modeling of US Fluvial, Pluvial, and Coastal Flood Hazard Under Current and Future Climates. [_Water Resources Research_](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2020WR028673).
...
- Hsiang, Oliva, and Walker (2019). The Distribution of Environmental Damages. [_Review of Environmental Economics and Policy_](https://www.journals.uchicago.edu/doi/10.1093/reep/rey024).
- Dingel, Meng, and Hsiang (2019). Spatial Correlation, Trade, and Inequality: Evidence from the Global Climate. [_NBER Working Paper_](https://www.nber.org/papers/w25447).
- Duffy et al (2019). Strengthened scientific support for the Endangerment Finding for atmospheric greenhouse gases. [_Science_](https://www.science.org/doi/10.1126/science.aat5982).
